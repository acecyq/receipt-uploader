...
def pdf_info(pdf_path):
    ...
    - Classify the type of expense carefully. Items meant for educational use or curriculum must be categorized as 'Teaching Materials'. Do not use raw text items like 'Merchandise Subtotal' as the type of expense.
